    ...
    Game.prototype={
        ...
        netTooSlow:function(){
            ...
            var html = ' <div><p>渣网速</p><p>没有擦掉熊</p></div>'+
                    '<div class="btn_wrapper"> <div onclick="navigator.share({url:"/index.html"})" id="shareGame" class="btn">分享</div>'+
        ...
        eraseDone:function(num){
            ...
            var html = ' <div><p>'+this.runTime/10+'秒内我擦死了'+this.eraseCount+'只熊孩子！</p>'+'</div>'+
                '<div class="btn_wrapper"> <div id="shareGame" class="btn">分享</div>'+
        ...
        infoDialog:function(){
            var html = ' <div><p>我擦！熊孩子！</p><p>'+this.timeLimit/10+'秒看你能擦几个？</p></div>'+
                '<div class="btn_wrapper"> <div id="startGame" class="btn">开始</div><div id="shareGame" class="btn">分享</div><p><a class="contact" href="http://tieba.baidu.com?fr=washbear" ></a></p>'+
                '</div>';
            this.showDialog(html);
        },
